      ...
      <div className="w-full mb-8 mx-auto">
        <div className="relative mb-4">
          <input 
            ...
            className="w-full p-4 bg-white/20 border border-white/20 text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-white/30 placeholder-white/70" 
            value={newTaskText} 
        ...
        {/* Add Task button - Quarter width on desktop and left-aligned */}
        <div className="flex justify-center sm:justify-start mt-4">
          <button 
            className="w-full sm:w-1/4 bg-white hover:bg-white/90 active:bg-white/80 text-indigo-900 px-8 py-3 rounded-lg flex items-center justify-center transition-all duration-150 font-medium text-base shadow-md"
            onClick={addTask}
          >
